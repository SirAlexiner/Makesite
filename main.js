...
$('.div5').css("top", "0");
setTimeout(function () {
$('.div5').css("position", "relative");
setTimeout(function () {
$('.div5').css("position", "absolute");
setTimeout(function () {
$('.div5').css({"background-color": "red", "width": "50px"});
setTimeout(function () {
$('.div5').css("height", "50px");
setTimeout(function () {
$('.div5').css("border-radius", "500px");
setTimeout(function () {
$('.div5').css("float", "right");
setTimeout(function () {
$('.div5').css("right", "50px");
setTimeout(function () {
$('.div5').css("margin", "5px");
...
setTimeout(function () {
$('.div5').css("right", "571px");
setTimeout(function () {
$('.div4').css("right", "587px");
setTimeout(function () {
